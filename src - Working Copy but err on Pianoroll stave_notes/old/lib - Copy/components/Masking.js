...
console.log(this.props)
            ...
            if (Array.isArray(treble_maskings) && treble_maskings.length){
                ...
                for (var i=0; i<treble_maskings.length; i++){
                    ...
                    var notehead = new VF.NoteHead({duration:'128', line: linenote, custom_glyph_code:"vd2", glyph_font_scale: treble_maskings_notesize[i], style:{fillStyle: treble_maskings_colors[i]}}) 
            ...
            if (Array.isArray(bass_maskings) && bass_maskings.length){
                ...
                for (var i=0; i<bass_maskings.length; i++){
                    ...
                    var notehead = new VF.NoteHead({duration:'4', line: linenote, custom_glyph_code:"vd2", glyph_font_scale: bass_maskings_notesize[i], style:{fillStyle: bass_maskings_colors[i]}}) 
                    maskings_b.push(notehead)
                }
                
            
            var voice2 = new VF.Voice({num_beats: 1,  beat_value: 4});
            var custom_notes2=maskings_b
            voice2.addTickables(custom_notes2);
