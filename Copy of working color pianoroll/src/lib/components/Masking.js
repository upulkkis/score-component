...
console.log(this.props)
            ...
            if (Array.isArray(bass_maskings) && bass_maskings.length){
                ...
                for (var i=0; i<bass_maskings.length; i++){
                    ...
                    var notehead = new VF.NoteHead({duration:'128', line: linenote, custom_glyph_code:"vd2", glyph_font_scale: bass_maskings_notesize[i], style:{fillStyle: bass_maskings_colors[i]}}) 
                    notehead.setCenterAlignment(true)
